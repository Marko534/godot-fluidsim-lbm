...
const float w[Q] = {
    ...
    2.0/27.0, 2.0/27.0, 2.0/27.0,                     // 1-6: face (±x, ±y, ±z)
    2.0/27.0, 2.0/27.0, 2.0/27.0,

    1.0/54.0, 1.0/54.0, 1.0/54.0, 1.0/54.0,           // 7-18: edge (12 directions)
    1.0/54.0, 1.0/54.0, 1.0/54.0, 1.0/54.0,
    1.0/54.0, 1.0/54.0, 1.0/54.0, 1.0/54.0,

    1.0/216.0, 1.0/216.0, 1.0/216.0, 1.0/216.0,       // 19-26: corner (8 directions)
...
const ivec3 c[Q] = {
    ...
    ivec3( 1,  0,  0), ivec3(-1,  0,  0),               // 1,2: ±x
    ivec3( 0,  1,  0), ivec3( 0, -1,  0),               // 3,4: ±y
    ivec3( 0,  0,  1), ivec3( 0,  0, -1),               // 5,6: ±z

    ivec3( 1,  1,  0), ivec3(-1, -1,  0),               // 7,8
    ivec3( 1,  0,  1), ivec3(-1,  0, -1),               // 9,10
    ivec3( 0,  1,  1), ivec3( 0, -1, -1),               // 11,12
    ivec3( 1, -1,  0), ivec3(-1,  1,  0),               // 13,14
    ivec3( 1,  0, -1), ivec3(-1,  0,  1),               // 15,16
    ivec3( 0,  1, -1), ivec3( 0, -1,  1),               // 17,18

    ivec3( 1,  1,  1), ivec3(-1, -1, -1),               // 19,20
    ivec3( 1,  1, -1), ivec3(-1, -1,  1),               // 21,22
    ivec3( 1, -1,  1), ivec3(-1,  1, -1),               // 23,24
    ivec3(-1,  1,  1), ivec3( 1, -1, -1)                // 25,26
};

const int cp[Q] = {
    0,                                                   // 0: rest → self
    2,  1,  4,  3,  6,  5,                              // 1-6: face opposites
    8,  7, 10,  9, 12, 11, 14, 13, 16, 15, 18, 17,     // 7-18: edge opposites
    20, 19, 22, 21, 24, 23, 26, 25                      // 19-26: corner opposites
};
